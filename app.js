...
const { authRoute, invoiceRoute, utilsRoute, entityRoute, webHookRoute, customerRoute, inventoryRoute, quoteRoute, accountantRoute, reportingRoute, recurringInvoiceRoute, expenseRoute } = require('./src/routes');
